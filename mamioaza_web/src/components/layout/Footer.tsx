            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-600 text-sm">Zavolajte nám</p>
                  <a href="tel:+421903123456" className="text-primary hover:text-primary-dark transition-colors font-medium">
                    +421 903 123 456
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-600 text-sm">Napíšte nám</p>
                  <a href="mailto:info@mamioaza.sk" className="text-primary hover:text-primary-dark transition-colors font-medium">
                    info@mamioaza.sk
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col">
                  <p className="text-neutral-600 text-sm">Kde nás nájdete</p>
